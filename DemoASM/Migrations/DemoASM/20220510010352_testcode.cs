...
{
    public partial class testcode : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__Store__UserId__5CD6CB2B",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Book__447D36EBE5B003C5", x => x.ISBN);
                    table.ForeignKey(
                        name: "FK__Book__StoreId__5FB337D6",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Cart__B3CF1F22C0B54B45", x => new { x.UserId, x.ISBN });
                    table.ForeignKey(
                        name: "FK__Cart__ISBN__6A30C649",
                        column: x => x.ISBN,
                        principalTable: "Book",
                        principalColumn: "ISBN");
                    table.ForeignKey(
                        name: "FK__Cart__UserId__693CA210",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderDet__67D788A1F32196A2", x => new { x.OrderId, x.ISBN });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK__OrderDetai__ISBN__66603565",
                        column: x => x.ISBN,
                        principalTable: "Book",
                        principalColumn: "ISBN");
                });
